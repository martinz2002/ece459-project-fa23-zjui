...
%todo: 讨论Hilbert在现实中应该如何实现，为什么这里用Hilbert而不是LPF，二者区别？
%? Hilbert能否在现实中实现？如果能，是如何避免下面那个问题的？
%? 用LPF，会留下fc-bw到fc之间的频谱，但我们的lpf不理想，会把f>fc的部分频谱也留下
...
\end{align}
where $P$ is the power of the message signal, $B_T$ is the noise bandwidth of the BPF, and $W$ is the message bandwidth. %? Relationship between B_T and W, is B_T = W?
